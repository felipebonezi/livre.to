...
# --- !Ups
insert into user (id,access_token,login,password,name,status,gender,modified_at,mail) values (  1,'token','admin','admin','Administrador','ACTIVE','MALE',null,'admin@livreto.com.br');
