...
# --- !Ups
insert into user (id,access_token,login,password,name,status,gender,modified_at,mail) values (nextVal('user_id_seq'),'token','admin','admin','Administrador','ACTIVE','MALE',now(),'admin@livreto.com.br');
